 ...
 * @author root
 */
public class SixthTurnTemplate extends BasicBuildingTemplate {
        
    public SixthTurnTemplate(){}
    ...
    public static BuildingInstance build(int unit_x, int unit_z, int unit_height, Material mat){
        ...
        if( unit_height < SixthTurnTemplate.MIN_UNIT_HEIGHT )
           unit_height = SixthTurnTemplate.MIN_UNIT_HEIGHT;  
