 ...
 * @author root
 */
public class QuarterTurnTemplate extends BasicBuildingTemplate {
        
    public QuarterTurnTemplate(){}
    ...
    public static BuildingInstance build(int unit_x, int unit_z, int unit_height, Material mat){
        ...
        if( unit_height < QuarterTurnTemplate.MIN_UNIT_HEIGHT )
           unit_height = QuarterTurnTemplate.MIN_UNIT_HEIGHT;  
        ...
        fullGeom.setLocalRotation(
            fullGeom.getLocalRotation().fromAngles(0, FastMath.QUARTER_PI, 0)
        );
