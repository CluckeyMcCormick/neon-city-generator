 ...
 * @author frick
 */
public class OpenBox extends Mesh{ 
    
    public OpenBox(float width, float length, float height){
        Vector2f[] texture = new Vector2f[16];
    ...
    public OpenBox(float width, float length, float height, Vector2f[] texture){
        this.buildBox(width, length, height, texture);
    }
